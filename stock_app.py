...
# ===== 更新公告文字 =====
CHANGELOG_TEXT = """
2026.05.27 左側設定新增評分權重設定：可選擇預設或自訂權重
2026.05.27 強化評分：新增乖離率、相對0050強弱/RPS proxy、三大法人籌碼
2026.05.27 新增籌碼強弱分析：法人買賣超趨勢、外資投信動向、法人20日累計買賣超等
2026.05.27 在各指標新增說明文字，幫助理解指標意義與使用方法
